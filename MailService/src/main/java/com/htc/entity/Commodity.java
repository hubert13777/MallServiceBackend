...
public class Commodity {
    ...
    private String pictureUrl1;     // varchar(80)
    private String pictureUrl2;     // varchar(80)
    private String pictureUrl3;     // varchar(80)
    private String specification;   // varchar(100) COMMENT '细节'
    private String generateInformation; // varchar(40)
    private String iconUrl;         // varchar(80)
